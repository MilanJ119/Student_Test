...
class StudentLogin extends JPanel implements KeyListener{
	...
	ImageIcon i2=new ImageIcon("buttonR.png");
	Image reg=i2.getImage();
	ImageIcon i3=new ImageIcon("buttonB.png");
	Image back=i3.getImage();
	StudentLogin(FDemo f){
		setLayout(null);
		...
		add(b1);
		b2=new JButton(i2);
		b2.setBounds(250,355,110,30);
		add(b2);
		b3=new JButton(i3);
		b3.setBounds(250,480,110,30);
		add(b3);
